...
enum TILE_TYPE{ EMPTY, WALL, NODE, PLAINS, PEASANT, TREE, STOCKPILE, BLUEPRINT, WOOD_WALL_BLUEPRINT};
enum ACTIVITY{ NOTHING, CUTTING_TREES, STOCKPILING, BUILDING, GETTING_STUFF_FROM_STOCKPILE };
enum OCCUPATION {IDLER, HAULER, WOODCUTTER, BUILDER};
